...
// Initialize charts directly without DOMContentLoaded since type="module" implies defer
  ...
  new Chart(ctxAnalytics, {
    ...
    data: {
      ...
      datasets: [
        {
          label: "This Year",
          data: [2000, 3500, 4200, 4500, 6000, 6500, 6200, 5000, 5300, 4500, 5200, 4900],
        ...
        {
          label: "Last Year",
          data: [1000, 2000, 2500, 2800, 3200, 3900, 4210, 3800, 3500, 2800, 3200, 2900],
